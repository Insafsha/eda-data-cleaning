...
![Логарифм цены](results/plots/09_log_price_distribution.png)
...
- `life_sq` ↔ `full_sq` ожидаемо сильно коррелируют друг с другом
- `price_per_m2` связан с ценой значительно сильнее, чем площадь сама по себе
- `kitch_sq` коррелирует со стоимостью слабее — кухня не ключевой фактор
