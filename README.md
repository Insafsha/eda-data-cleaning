# Анализ и очистка данных о недвижимости (EDA)

##  Описание проекта

Этот проект — полноценное исследование большого датасета недвижимости (30 000+ объектов, 290+ признаков).  
...
В рамках проекта использовался датасет реальных сделок с недвижимостью Москвы, опубликованный на платформе Kaggle:

**Название:** Sberbank Russian Housing Market (Real Estate Prices)  
**Источник:** https://www.kaggle.com/competitions/sberbank-russian-housing-market

**Размер:** ~300 000 строк, десятки признаков по объектам, инфраструктуре и ближайшим объектам
